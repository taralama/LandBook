...
const Navbar = () => {
  ...
  >
    ...
    <marquee class='text-white' behavior="" direction="">Latest House are listed </marquee>
  </Box>
  <Box
    h={"6vh"}
    w={"100vw"}
  ...
  >
    ...
    <Menu>
      ...
      <MenuList display={'flex'} border={'none'}  flexDirection={'column'} alignItems={'center'} fontFamily={'manrope'}boxShadow={'1px 2px 8px'}>
        ...
        <Link to={'/profile'}><Text _hover={{backgroundColor:'gray', cursor:'pointer'}}>Profile</Text></Link>
        <Link to={'/setting'}><Text _hover={{backgroundColor:'white'}}>Setting</Text></Link>
